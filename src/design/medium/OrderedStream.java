...
public class OrderedStream {
    ...
    public List<String> insert(int idKey, String value) {
        ...
        while (ptr< values.length && values[idKey]!=null) {
...
/*
Basically, the idea is that you need to return a longest list that start at index of ptr.
if ptr is not pointing an element, you need to return a empty list.
