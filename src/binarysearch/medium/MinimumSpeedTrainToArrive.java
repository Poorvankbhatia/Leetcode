...
public class MinimumSpeedTrainToArrive {
    ...
    private boolean possibleSpeed(int[] dist, int speed, double target) {
        double total = 0;
        for (int i = 0; i < dist.length; i++) {
            if(i==dist.length-1) {
    ...
    public static void main(String[] args) {
        System.out.println(new MinimumSpeedTrainToArrive().minSpeedOnTime(new int[]{1,1,100000},2.01));
    }
