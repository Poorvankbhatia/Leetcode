...
For example, we start with A = [3,8,0,9,2,5], which is a run-length encoding of the sequence [8,8,8,5,5].  This is because the sequence can be read
as "three eights, zero nines, two fives".
...
/**
 * Created by poorvank.b on 15/09/18.
 */
public class RLEIterator {
    ...
    public int next(int n) {
        while (currentIndex < A.length && n > A[currentIndex]) {
            n -= A[currentIndex];
            currentIndex += 2;
        }
    ...
    public static void main(String[] args) {
        int[] arr = new int[]{635,606,576,391,370,981,36,21,961,185,124,210,801,937,22,426,101,260,221,647,350,180,504,39,101,989,199,358,732,839,919,169,673,967,58,676,846,342,250,597,442,174,472,410,569,509,311,357,838,251};
        RLEIterator rleIterator = new RLEIterator(arr);
        System.out.println(rleIterator.next(5039));
        System.out.println(rleIterator.next(62));
        ...
        System.out.println(rleIterator.next(43));System.out.println(rleIterator.next(42));
