...
Output: 16
Explanation: You will be initially given box 0. You will find 7 candies in it and boxes 1 and 2. Box 1 is closed and you don't have a key
for it so you will open box 2. You will find 4 candies and a key to box 1 in box 2.
...
public class MaxCandies {
    ...
    public static void main(String[] args) {
        ...
        int[][] candidateBoxes = new int[][]{
                {1,2},{3},{},{}
        };
        int[] initialBox = new int[]{0};
        System.out.println(new MaxCandies().maxCandies(status,candies,keys,candidateBoxes,initialBox));
    }
