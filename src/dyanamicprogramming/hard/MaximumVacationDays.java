...
Your job is to schedule the traveling to maximize the number of vacation days you could take, but there are certain rules and
...
Solution 2. DP. dp[i][j] stands for the max vacation days we can get in week i staying in city j.
