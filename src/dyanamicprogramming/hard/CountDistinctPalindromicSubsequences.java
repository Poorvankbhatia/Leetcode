...
The essence is actually the same. Let's first look at the recursive solution with memory array memo. The idea of ​​this solution is to peel
...
layer "b _ _ b" This will generate two palindrome subsequences "b" and "bb", then recursively into the middle part, calculate the number
