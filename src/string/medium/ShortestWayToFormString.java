...
public class ShortestWayToFormString {
    ...
    public static void main(String[] args) {
        String source = "aaaa";
        String target = "aaaaaaaaaa";
        System.out.println(new ShortestWayToFormString().shortestWay(source, target));
    }
...
we can build a map which key is from 'a' -> 'z', the value is idx for this char in src. because idx is add from small to big. when we iterate tar[i],
we can easily to find the tar[i]'s idx list. to search is there a idx is larger or equal than j+1. it is logM. and we have N char in tar,
so the time complexity is N * logM
